import {OasisOptionModalsComponent} from '/micro/oasis/javascripts/oasis-option-ctl-modals-component.js'; 
...
<div class="nav-title  mt-3">
    ...
    <li v-if="initiatorRoleV()">
      <a  class="dropdown-item"  :href="'/micro/oasis/setting?oasis_id='+oasisId">
        <button type="button" class="btn  oasis-option">
