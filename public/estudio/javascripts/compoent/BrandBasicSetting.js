    ...
    data(){
        return {
            ...
            explainTopic: [
                ...
                {title: "合作资源",content: "合作的基础就是让各方的资源相互碰撞，展示你拥有的资源（比如：技术、设计、研发、流量、5万用户、5000资金），着手超多合作吧。（支持最大长度 500 字符）"},
                {title: "自定义职业",content: "职业门类丰富，如果平台提供的数据中没有录入目标职业，可以通过自定义职业进行DIY.（提示：自定义职业生效需要确保职业选择为自定义。支持最大长度 60 字符）"},
                {title: "夜间咨询",content: "夜间咨询处于开启状态，表示在每天夜晚(18:00 ～ 22:00)，你为有需要的用户提供无偿、免费的咨询服务。建议每次咨询时长设置为15min、30min 或者 1h。默认为关闭状态"},
                {title: "品牌唯一标识",content: "品牌唯一标识是由字母、数字、点（.）组成的简单的身份字符串，更容易分享和传播，你可通过 https://bluvarri.com/品牌唯一标识@blv.bi 直接访问相应的品牌主页。支持最大长度为32"},
